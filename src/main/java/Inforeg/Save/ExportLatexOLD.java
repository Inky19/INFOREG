...
public class ExportLatexOLD {
    ...
    /**
     * Méthode permettant de créer le JPanel contenant les boutons permettant de
     * modifier les couleurs des arcs en noir
     *
     * @param d Draw
     */
    ...
    /**
     * Méthode permettant de créer le JPanel contenant les boutons permettant de
     * modifier la couleur des noeuds
     *
     * @param d Draw
     */
    ...
    /**
     * Méthode permettant de créer le JPanel contenant le source Latex de
     * l'export
     *
     * @param d Draw
     */
    ...
    /**
     * Méthode permettant de générer le source Latex pour les arcs Cas Pondéré
     * Orienté
     *
     * @param d Draw
     * @return String
    ...
    /**
     * Méthode permettant de générer le source Latex pour les arcs Cas non
     * Pondéré Orienté
     *
     * @param d Draw
     * @return String
    ...
    public String writeLinesNonPond(Draw d) {
        ...
        for (int i = 0; i < d.getNodes().size(); i++) {
            ...
            Node dest = d.findNode(l.getToPoint().x, l.getToPoint().y);
            Color c = l.getC();
            arcs += "\\draw[" + writeArcColor(c) + "style] (" + String.valueOf(src.getLabel());
            if (src.equals(dest)) {//boucle sur le même noeud
                arcs += ") to [loop] (" + String.valueOf(dest.getLabel()) + ") {};\n";
            } else {
                arcs += ")--(" + String.valueOf(dest.getLabel()) + ") {};\n";
            }
        }
        return arcs;
    }
