...
/*================================================
Classe GOriente définissant un Graph non orienté
Sous classe de la classe abstraite Graph
Auteur : Béryl CASSEL
Date de création : 27/01/2022
Date de dernière modification : 08/03/2022
=================================================*/
public class GraphNO extends Graph {

    public GraphNO(Draw d) {
        super(d);
    }

    @Override
    /**
     * Méthode d'ajout d'un arc dans le graphe Avec sauvegarde du graphe initial
     *
